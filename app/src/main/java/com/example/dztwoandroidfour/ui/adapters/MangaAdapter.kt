...
import com.example.dztwoandroidfour.databinding.ItemMangaBinding

class MangaAdapter(private val onClickListener: (id: String) -> Unit): ListAdapter<Manga, MangaAdapter.MangeViewHolder>(
    diffUtil
) {
